...
public sealed class Program : MyGridProgram {
    ...
    private void initMenu(IMyTextPanel lcd) {
        ...
        Menu dockW8 = new SimpleMenu("dockW8", submenu);
        dockW8.add(new ChangeVarMenuItem("dockW8", 1, "dockW8+", "={0}"));
        dockW8.add(new ChangeVarMenuItem("dockW8", -1, "dockW8-", "={0}"));
        submenu.add(dockW8);
        
        Menu dPoint = new SimpleMenu("dPoint", submenu);
        dPoint.add(new ChangeVarMenuItem("dPoint", 0.05f, "dPoint+", "={0}"));
        dPoint.add(new ChangeVarMenuItem("dPoint", -0.05f, "dPoint-", "={0}"));
        submenu.add(dPoint);

        menu.add(new SimpleMenuItem(new SimpleMsg("help", "CTRL + 1: \nbutton 3 - set dock (must be docked)\nbutton4 - set mine area\nbut 5 - start mine\nbut1 - pause", null)));
        menu.add(submenu);
        menu.add(new SimpleMenuItem(new SimpleMsg("vars help", "dPoint - movmnt inaccuracy\n", null)));
    }
 ...
 * ============================================================*/
    public class Rider {
        ...
        public bool moveTo(Vector3D point, Vector3D direction, Vector3D orintation) {
            ...
            runtime.UpdateFrequency = length > 5 ? UpdateFrequency.Update10 : UpdateFrequency.Update1;
            if (length > ((float)ctx.get("dPoint"))) {
