...
//
//public sealed class Octopus : MyGridProgram {
//    
//    int TickCount;
//    int Clock = 10;
...
//                string RockStr = ScrObj.GetPublicText();
...
//
//                Vector3D GravNorm = Vector3D.Normalize(new Vector3D(-sfiftX, -1, -shiftZ));
//                Vector3D TargetNorm = Vector3D.Normalize(Target - V3Dcenter);
//
//                if (GravVector.LengthSquared() > 0.2f)
//                {
//                    GravNorm = Vector3D.Normalize(GravVector);
//                    GravNorm = Vector3D.Normalize(Vector3D.Transform(GravNorm + RemCon.GetPosition(), InvMatrix) - V3Dcenter - new Vector3D(sfiftX, 0, shiftZ));
//                }
//
//                if ((GravVector.LengthSquared() < 0.2f) && ((myDriller.CurrentStatus == Commands.ToDrillPoint) || (myDriller.CurrentStatus == Commands.ToBase)))
//                {
...
//                if (Vector3D.Transform(PlanetCenter, DockMatrix).Length() > FlyHeight)
//                    FHTemp += FHTemp;
...
//            {
//                bool Complete = false;
//                float MaxUSpeed = 0, MaxFSpeed;
//                Vector3D gyrAng = GetNavAngles(new Vector3D(0, 200, 0), DrillMatrix);
//                Vector3D MyPosDrill = Vector3D.Transform(MyPos, DrillMatrix);
//
//                double FHTemp = FlyHeight;
//                if (Vector3D.Transform(PlanetCenter, DrillMatrix).Length() > FlyHeight)
//                    FHTemp += FHTemp;
//                if (RemCon.GetNaturalGravity().LengthSquared() > 0.2f)
//                    MaxUSpeed = (float)Math.Sqrt(2 * Math.Abs(FHTemp - (MyPos - PlanetCenter).Length()) * myDriller.thrustBlock.YMaxA) / 1.2f;
...
//                    if ((!(myDriller.EmergencyReturn || myDriller.GoHome) && (ShaftN < ParentProgram.MaxShafts)) || (RemCon.GetNaturalGravity().LengthSquared() > 0.2f))
//                        Complete = true;
//                    else
//                    {
//                        myDriller.thrustBlock.SetOverrideAccel("U", 1f);
//                        if (MyPosDrill.GetDim(1) > 200)
//                            Complete = true;
//                    }
//                string strStatus = " STATUS\n";
//                if (myDriller.Command == Commands.DepoDrill)
...
//                        {
//                            if (crateItems[j].Content.SubtypeId.ToString() == "Iron")
//                                FeAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Cobalt")
//                                CbAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Nickel")
//                                NiAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Magnesium")
//                                MgAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Gold")
//                                AuAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Silver")
//                                AgAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Platinum")
//                                PtAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Silicon")
//                                SiAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Uranium")
//                                UAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Stone")
//                                StoneAmount += (int)crateItems[j].Amount;
//                            else if (crateItems[j].Content.SubtypeId.ToString() == "Ice")
